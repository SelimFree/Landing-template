                        ...
                        {languages.map((lang) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex w-full items-center px-4 py-2.5 text-left transition-colors ${isActive
                                        ? "bg-gray-50 border-l-2 border-primary-800"
                                        : "border-l-2 border-transparent hover:bg-gray-50 hover:border-gray-300"
                                        }`}
                                    role="menuitem"
                                >
                                    <Text className={`text-xs font-bold tracking-widest uppercase ${isActive ? "text-primary-900" : "text-gray-500"
                                        }`}>
                                        {lang.label}
                                    </Text>
                                </button>
